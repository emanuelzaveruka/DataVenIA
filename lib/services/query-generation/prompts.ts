...
- NO MÁXIMO 2 A 3 PALAVRAS-CHAVE por query, nunca mais. A busca do TJPR é AND estrito: cada palavra a mais reduz a contagem de resultados exponencialmente, e a partir de 4-5 palavras a busca costuma devolver ZERO resultados — mais palavras não deixam a busca "mais precisa", deixam vazia. Prefira "plano saude reajuste" a "plano saude reajuste individual nao adaptado".`;
...
Gere exatamente 2 queries de pesquisa de jurisprudência: uma para a tese principal do cliente e uma para jurisprudência contrária. Cada query deve referenciar o id de uma das questões jurídicas acima e ser composta por, no máximo, 2 a 3 keywords curtas compatíveis com a busca do TJPR.`;
}
